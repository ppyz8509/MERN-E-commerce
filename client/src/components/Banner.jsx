    ...
    <div className="section-container bg-gradient-to-r from-[#FAFAFA] from-0% to-[#FCFCFC] to-100%">
      <div className="py-24 flex flex-col md:flex-row-reverse justify-between items-center">
        ...
        <div className="md:w-1/2 space-y-7 px-4">
            <h2 className="md: text-4xl  font-bold mb:leading-snug leading-sung">
                Discover Uniq <span className=" text-red">Software Swag</span> for Every Coding  
            </h2>
            <p className="text-xl text-[#4A4A4A">
                Ouer mission : to merge fash with functionality 
            </p>
            Left</div>
      </div>
    </div>
